...
import Icon from './assets/icons/ssv_logo.png';
    ...
    <>
      <div className="bg-slate-800 py-0.5 flex justify-between draggable text-white">
        <div className="flex flex-row px-2 items-center">
          <img className="h-6 lg:-ml-2 mr-3" src={Icon} alt="Icon of Electron" />
          <p className="font-bold md:pt-1 md:-ml-1 lg:-ml-2">Ceremonia</p>
        </div>
